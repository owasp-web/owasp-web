-- Setup Enhanced Schema and Import OWASP Juice Shop (FIXED VERSION)
...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS videos JSONB;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS tutorials JSONB;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS case_studies JSONB;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS integrations JSONB;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS third_party_tools JSONB;
...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS security_advisories JSONB;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS release_notes JSONB;
...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS dependents TEXT[];

-- Enhanced classification
ALTER TABLE projects ADD COLUMN IF NOT EXISTS industry_usage TEXT[];
ALTER TABLE projects ADD COLUMN IF NOT EXISTS compliance_standards TEXT[];
ALTER TABLE projects ADD COLUMN IF NOT EXISTS threat_categories TEXT[];
...
-- Now insert the OWASP Juice Shop project with matching columns/values
...
| XSS | 3 | API-only XSS, Bonus Payload, DOM XSS |',
  ...
  'The OWASP Juice Shop project provides comprehensive overview documentation including architecture diagrams, challenge explanations, and detailed vulnerability descriptions.',
