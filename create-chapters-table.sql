-- Create chapters table for OWASP chapters management
...
CREATE TABLE IF NOT EXISTS chapters (
  ...
  region VARCHAR(50) NOT NULL CHECK (region IN ('Africa', 'Asia', 'Europe', 'North America', 'South America', 'Central America', 'Oceania')),
  description TEXT,
  tagline TEXT,
...
CREATE INDEX IF NOT EXISTS idx_chapters_content_status ON chapters(content_status);
CREATE INDEX IF NOT EXISTS idx_chapters_city ON chapters(city);
CREATE INDEX IF NOT EXISTS idx_chapters_country ON chapters(country);
...
-- Add more sample chapters for other regions if needed
INSERT INTO chapters (
